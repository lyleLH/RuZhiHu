...
//									  lineBreakMode:NSLineBreakByWordWrapping];
    CGSize textSize = [_textLabel.text boundingRectWithSize:maxSize options:(NSStringDrawingUsesFontLeading | NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin) attributes:@{NSFontAttributeName:_textLabel.font} context:NULL].size;
#else
	CGSize textSize = [_textLabel.text sizeWithFont:_textLabel.font constrainedToSize:maxSize
