...
+ (NSString *)strFromString:(NSString *)string withFormat:(NSString *)format {
...
+ (NSString*)dateFromTimestamp:(long long int )timestamp {
    
    double lastactivityInterval = timestamp;
